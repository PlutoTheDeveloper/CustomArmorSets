...
namespace CustomArmorSets\Core\Commands;
...
class CustomArmorCommand extends PluginCommand
{
    ...
    public function __construct(Main $plugin)
    {
        ...
        $this->setAliases(["customarmor", "ca"]);
        $this->setDescription("CustomArmor Base Command");
        $this->setPermission("customarmor.command");
        $this->plugin = $plugin;
    }
    ...
    {
        if (!$sender->hasPermission("customarmor.command")) {
